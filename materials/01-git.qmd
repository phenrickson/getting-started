...
## {background-image="images/phd_final.gif" background-position="center" background-color="white" background-size="contain"}
...
#| fig-width: 10
#| fig-dpi: 300
#| fig-cap: 'sentiment analysis via tokenization and afinn'
...
#| fig-width: 10
#| fig-dpi: 300
#| fig-cap: 'sentiment analysis via tokenization and bing'
...
#| fig-width: 10
#| fig-dpi: 300
#| fig-cap: 'sentiment analysis via sentimentr'
...
#| fig-width: 10
#| fig-dpi: 300
#| fig-cap: 'estimated sentiment by character via sentimentr'
#| message: false
#| warning: false
...
# With and Without Git: <br> Predictive Modeling
...
## {background-image="images/xkcd_how_git.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_1.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_2.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_3.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_4.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_5.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_6.png" background-position="center" background-color="white" background-size="contain"}

## {background-image="images/diag_7.png" background-position="center" background-color="white" background-size="contain"}

## {background-image="images/diag_8.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_9.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_10.png" background-position="center" background-color="white" background-size="contain"}

## {background-image="images/diag_11.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_12.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/diag_13.png" background-position="center" background-color="white" background-size="contain"}

## {background-image="images/diag_15.png" background-position="center" background-color="white" background-size="contain"}

## {background-image="images/diag_16.png" background-position="center" background-color="white" background-size="contain"}
...
1. Create a new RStudio project
2. Check 'Create a git repository'
3. **usethisthis::use_git()** to initialize a local repository, add and commit your initial files 
...
## {background-image="images/add_readme.png" background-position="center" background-color="white" background-size="contain"}

##

I create the file in my working directory, which causes it to appear in my Git tab in RStudio.

## {background-image="images/untracked.png" background-position="center" background-color="white" background-size="contain"}

## 

Checking the file adds it to staging.

## {background-image="images/staged.png" background-position="center" background-color="white" background-size="contain"}

## 

We can then commit the file.

## {background-image="images/rstudio_commit.png" background-position="center" background-color="white" background-size="contain"}

## {background-image="images/rstudio_committed.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/three_states.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/lifecycle.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/git_under_the_hood.png" background-position="center" background-color="white" background-size="contain"}
...
## {background-image="images/clone.webp" background-position="center" background-color="white" background-size="contain"}
...
2. Open a New Project on RStudio
3. Create from Version Control
4. Paste Repository URL from GitHub repo
5. Set name and location of project
6. Create project
...
Okay, so you have submitted pull requests, which I, the reviewer, have taken a look at.
...
This pull request went into `main`, when we wanted to submit it into `feature`.
...
[view commit](https://github.com/ds-workshop/board_games/blob/553d1fbf323b5ad59778299b5ff80a61da9739c8/analysis.md)

## 

I, the reviewer, did not notice that this pull request didn't have a completed analysis. 

. . .

I should have instead grabbed one of the other pull requests, which was finished.

[view other pull request](https://github.com/ds-workshop/board_games/pull/7/files)
...
![](images/revert.png){fig-align="center"}

## 

Under the hood, this amounts to:

1. Checking out the repository at the previous commit
2. Creating a new branch `revert-name-of-last-pr`
3. Merging `revert-name-of-last-pr` into main
...
## {background-image="images/revert-history.png" background-position="center" background-color="white" background-size="contain"}
