...
## This is the repo that trains a user specific model and creates a report with recommended games for their collection

## Motivation

Do these projects represent the height of data science maturity and sophistication? 

## {background-image="images/shrug.png" background-position="center" background-color="#4f6952" background-size="cover"}
